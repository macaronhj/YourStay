		           ...
		           <div class="container">
				        <div style="margin-top:50px;" class="image-upload" id="image-upload1">
				            ...
				            <form method="post" enctype="multipart/form-data">
				                ...
				                <input type="file" id="chooseFile" name="chooseFile" accept="image/*" onchange="loadFile1(this)">
				            </form>
				            <div class="fileContainer">
				                <div class="fileInput" style="border: none;">
				                	<p id="fileName1"></p> 
		           ...
		           <div class="container">
				        <div style="margin-top:50px;" class="image-upload" id="image-upload2">
				            ...
				            <form method="post" enctype="multipart/form-data">
				                ...
				                <input type="file" id="chooseFile" name="chooseFile" accept="image/*" onchange="loadFile2(this)">
				            </form>
				            <div class="fileContainer">
				                <div class="fileInput" style="border: none;">
				                	<p id="fileName2"></p> 
